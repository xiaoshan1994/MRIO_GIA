...
#%% Estimated hanges in final demand with the products of meat cattle  after agreement (index=42)
...
#%%
# Identify top sectors that contribute to production-based emissions
...
#%%
# Identify top final demand spending sectors that contribute to consumption-based emissions
# Identify top countries where the specific country displaced emissions to
...
plt.setp(fig.get_xticklabels(), rotation=15, ha="right", rotation_mode="anchor")
fig.set_title("Consumption-based water consumption per country in UK processed agricutltural products (2020, Mm3)")
